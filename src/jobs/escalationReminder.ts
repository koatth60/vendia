...
export async function runEscalationReminderJob(): Promise<void> {
  ...
  for (const business of businesses) {
    ...
    // los demas negocios simplemente no reciben su recordatorios de escalacion y no hay error visible en ningun lado.
    ...
    try {
      ...
      console.error(`[ZAQI ALERT] escalationReminder: fallo el negocio ${business.id}, sigo con los demas:`, error);
    }
  }
}
