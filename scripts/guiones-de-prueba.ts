...
const GUIONES: Guion[] = [
  ...
  },
  {
    ...
    variantes: [
      [
        ...
        "uno solo, y pago todo cuando me llegue",
        "si",
        "listo",
        "si, todo bien",
      ],
      [
        "buenas, me interesan unos audifonos",
        "los AIRPODS SERIE 4",
        "uno",
        "Maria Gomez, CC 52889900, tel 3155556677, Carrera 45 #23-11, barrio El Poblado, Medellin",
        "pago todo por adelantado, por transferencia",
        "si",
        "dale pues",
        "perfecto",
      ],
      [
        "hola quiero el intercomunicador",
        "el Q58 Max",
        "dos",
        "mi nombre es Andres Quintero, cedula 79554433, numero 3209998877, Calle 80 #12-45 apto 302, barrio Suba, Bogota",
        "pago el producto ahora y el envio cuando llegue",
        "si",
        "listo",
        "si",
      ],
      [
        "hola, quiero un combo",
        "el Combo Pareja",
        "uno",
        "Diana Osorio, cedula 1038776655, celular 3021114455, Calle 5 #38-20, barrio San Fernando, Cali",
  ...
  },
  {
    ...
    variantes: [
      [
        "hola", "quiero el Smartwatch V20 Caballero y unos AIRPODS SERIE 4", "cuanto me sale todo junto?",
        "listo, me los llevo, uno de cada uno",
        "Sandra Ruiz, cedula 43556677, celular 3016665544, Calle 33 #22-10, barrio Laureles, Medellin",
        "pago todo cuando me llegue",
        "si", "listo", "si",
      ],
      [
        "hola", "me llevo dos Combo k11 Mini", "cuanto seria el total con envio a Bogota",
        "dale, quiero dos",
        "Julian Ospina, CC 80112233, tel 3187778899, Carrera 7 #45-12, barrio Chapinero, Bogota",
        "pago cuando me llegue",
        "si", "dale pues", "correcto",
      ],
      [
        "buenas", "quiero el COMBO SMARTWATCH T2000 ULTRA y el Intercomunicador Q58 Max", "cual es el total",
        "perfecto, uno de cada uno",
        "Paola Mendez, cedula 1122334455, celular 3145556677, Calle 12 #9-40, barrio Centro, Cali",
        "pago todo por adelantado, por transferencia",
        "si", "si", "listo",
      ],
      [
        "hola", "quiero 3 AIRPODS SERIE 4", "cuanto queda el total a Barranquilla",
        "dale, tres",
        "Ricardo Pena, cedula 72889900, celular 3005556677, Carrera 51B #82-30, barrio El Prado, Barranquilla",
        "pago cuando me llegue",
        "si", "listo", "si",
      ],
    ],
  ...
  },
  {
    ...
    variantes: [
      ["hola", "quiero cancelar mi pedido", "si, no lo quiero"],
      ["hola", "necesito cancelar la compra que hice", "si por favor"],
  ...
  },
  {
    ...
    variantes: [
      [
        "hola, quiero comprar un combo",
        "el COMBO SMARTWATCH T2000 ULTRA",
        "uno",
        "Laura Restrepo, cedula 1026778899, celular 3126667788, Calle 22 #14-50, barrio La Candelaria, Bogota",
        "pago todo por adelantado, por transferencia",
        "si",
        "[[img:sim.comprobante:89.000:NEQUI]] ya te transferi, aqui esta el comprobante",
        "listo",
      ],
      [
        ...
        "pago todo por adelantado, por transferencia",
        "si",
        "[[img:sim.comprobante:75.000:BANCOLOMBIA]] listo, ya hice la consignacion",
        "dale pues",
      ],
      [
        ...
        "pago el producto por transferencia y el envio cuando llegue",
        "si",
        "[[img:sim.comprobante:149.000:DAVIPLATA]] ya quedo el pago",
        "listo",
      ],
    ],
  },
  ...
  },
  {
    ...
    variantes: [
      [
        "hola",
        "[[img:sim.producto:Smartwatch V20 Caballero]] quiero este",
        "uno",
